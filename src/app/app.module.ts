...
// import {getActions} from './books/effects/book.effects.spec';
...
@NgModule({
  ...
  providers: [
    ...
    {
      provide: Http,
      useFactory: (backend: XHRBackend, options: RequestOptions, store: Store<State>) =>
          new HttpRequestService(backend, options, store), deps: [XHRBackend, RequestOptions, Store]
    },
    BooksService
  ],
